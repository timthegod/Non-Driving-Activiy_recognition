...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, classes, channel=20): # nb_classses changed from 101 to 3
        self.inplanes = 64
        ...
        self.fc_custom = nn.Linear(512 * block.expansion, self.classes)
...
def resnet18(classes, pretrained=False, channel= 20, **kwargs):
    """Constructs a ResNet-18 model.
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = ResNet(BasicBlock, [2, 2, 2, 2], classes= classes, channel=channel, **kwargs) #nb_classes change from 101 to 3 
    if pretrained:
...
def resnet34(classes, pretrained=False, channel= 20, **kwargs):
    model = ResNet(BasicBlock, [3, 4, 6, 3], classes=classes, channel=channel, **kwargs) #nb_classes change from 101 to 3 
    if pretrained:
...
def resnet50(classes, pretrained=False, channel= 20, **kwargs):
    
    model = ResNet(Bottleneck, [3, 4, 6, 3], classes=classes, channel=channel, **kwargs) #nb_classes change from 101 to 3 
    if pretrained:
...
def resnet101(classes, pretrained=False, channel= 20, **kwargs):
    
    model = ResNet(Bottleneck, [3, 4, 23, 3], classes=classes, channel=channel, **kwargs) #nb_classes change from 101 to 3 
    if pretrained:
